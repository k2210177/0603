...
ENTRY("_start")
MEMORY {
        vectors : org =0x080000, len =0x100
        ram     : org =0xffdf10, len =8k
        ram2    : org =0x080100, len =128k-0x100
...
SECTIONS
{
        .vectors : {
                ...
                LONG(ABSOLUTE(_start) | 0x5A000000)
                /* 0x90` */
                LONG((DEFINED(_int_imia3)?      ABSOLUTE(_int_imia3):   ABSOLUTE(_start)) | 0x5A000000)
                LONG((DEFINED(_int_imib3)?      ABSOLUTE(_int_imib3):   ABSOLUTE(_start)) | 0x5A000000)
                LONG((DEFINED(_int_ovi3)?       ABSOLUTE(_int_ovi3):    ABSOLUTE(_start)) | 0x5A000000)
                LONG(ABSOLUTE(_start) | 0x5A000000)
                /* 0xA0` */
                LONG((DEFINED(_int_imia4)?      ABSOLUTE(_int_imia4):   ABSOLUTE(_start)) | 0x5A000000)
                LONG((DEFINED(_int_imib4)?      ABSOLUTE(_int_imib4):   ABSOLUTE(_start)) | 0x5A000000)
                LONG((DEFINED(_int_ovi4)?       ABSOLUTE(_int_ovi4):    ABSOLUTE(_start)) | 0x5A000000)
                LONG(ABSOLUTE(_start) | 0x5A000000)
                /* 0xB0` */
